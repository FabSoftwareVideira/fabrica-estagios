...
from app.models import Aluno, Empresa, Estagio, Professor, Role, StatusEstagio, Supervisor, User
...
def seed_command():
    ...
    def ensure_user(username: str, email: str, password: str, roles: list[str]) -> User:
    ...
    if not estagio_existente:
        db.session.add(
            Estagio(
                ...
                horario_estagio='08:00 às 12:00',
